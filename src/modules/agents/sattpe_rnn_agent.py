...
class SAttPE_RNNAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(SAttPE_RNNAgent, self).__init__()
        self.args = args
        ...
        self.pe_output_w_attack_action_att = ScaledCrossAttention(
            q_emb_dim=self.enemy_feats_dim, v_emb_dim=self.rnn_hidden_dim,
        ...
        if self.args.map_type == "MMM":
            ...
            self.pe_output_w_rescue_action_att = ScaledCrossAttention(
                    q_emb_dim=self.ally_feats_dim, v_emb_dim=self.rnn_hidden_dim,
                    q_dim=self.rnn_hidden_dim, v_dim=self.rnn_hidden_dim, bias=False)
    ...
    def forward(self, inputs, hidden_state):
        ...
        enemy_feats_hh = self.pe_output_w_attack_action_att(enemy_feats_t, enemy_feats_hh)
        ...
        if self.args.map_type == "MMM":
            ...
            ally_feats_hh = self.pe_output_w_rescue_action_att(ally_feats_t, ally_feats_hh)
