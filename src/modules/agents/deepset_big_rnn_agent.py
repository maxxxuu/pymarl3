...
class DeepSetRNNAgent(nn.Module):
    def __init__(self, input_shape, args):
        ...
        self.fc1_ally = nn.Sequential(
            nn.Linear(self.ally_feats_dim, args.rnn_hidden_dim, bias=False),
            nn.ELU(),
        ...
        self.fc1_enemy = nn.Sequential(
            nn.Linear(self.enemy_feats_dim, args.rnn_hidden_dim, bias=False),
            nn.ELU(),
            nn.Linear(args.rnn_hidden_dim, args.rnn_hidden_dim, bias=False),
            nn.ELU(),
            nn.Linear(args.rnn_hidden_dim, args.rnn_hidden_dim, bias=False),
